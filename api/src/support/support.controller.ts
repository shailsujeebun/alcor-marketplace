...
export class SupportController {
  ...
  createTicket(
    ...
    return this.supportService.createTicket(userId, dto.subject, dto.body, dto.priority);
  }
  ...
  getMyTickets(
    ...
    return this.supportService.getUserTickets(userId, page ? +page : 1, limit ? +limit : 20);
  }
  ...
  getAllTickets(
    ...
    return this.supportService.getAllTickets(page ? +page : 1, limit ? +limit : 20, status);
  }
